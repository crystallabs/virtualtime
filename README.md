...
If there are multiple VTs set for a field, the matches are logically OR-ed, i.e. one match is enough for the field to match.
...
beginning, or to run procs which will return values produced in any desired way.
