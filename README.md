...
1. Materialization should never use default values. If the object does not have all required info, it should throw an Exception, unless a "hints" VD is provided to aid the materialization
