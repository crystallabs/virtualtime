...
jd. In essence if Y/m/d is set and weekday is later changed
...
automated script) where you would match a particular date, but only if
happens that that specific date falls on a particular day of week.
